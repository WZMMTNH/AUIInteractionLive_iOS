...
@interface AUILiveRoomVodPlay () <AVPDelegate>
...
@implementation AUILiveRoomVodPlay
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [play setImage:AUIInteractionLiveGetCommonImage(@"ic_player_play") forState:UIControlStateNormal];
        [play setImage:AUIInteractionLiveGetCommonImage(@"ic_player_pause") forState:UIControlStateSelected];
        ...
        progressView.minimumTrackTintColor = AUIInteractionLiveColourfulFillStrong;
        ...
        [shareButton setImage:AUIInteractionLiveGetCommonImage(@"ic_living_bottom_share") forState:UIControlStateNormal];
        ...
        [likeButton setImage:AUIInteractionLiveGetCommonImage(@"ic_living_bottom_like") forState:UIControlStateNormal];
...
- (void)layoutSubviews {
    ...
    self.likeButton.frame = CGRectMake(self.av_width - 36 - 16, self.bottomView.av_top - 4 - 36, 36, 36);
...
- (void)setFullScreen:(BOOL)fullScreen {
    ...
    if (_fullScreen) {
        ...
        self.shareButton.hidden = self.hiddenButtons;
        self.likeButton.hidden = self.hiddenButtons;
    }
...
- (void)setVodInfoModel:(AUIInteractionLiveVodInfoModel *)vodInfoModel {
...
- (void)setHiddenButtons:(BOOL)hiddenButtons {
    ...
    self.shareButton.hidden = hiddenButtons;
    self.likeButton.hidden = hiddenButtons;
}
