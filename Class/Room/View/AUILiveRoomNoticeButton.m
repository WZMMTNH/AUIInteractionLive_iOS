...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        iconView.image = AUIInteractionLiveGetCommonImage(@"ic_living_notice");
        ...
        [showButton setImage:AUIInteractionLiveGetCommonImage(@"ic_living_notice_open") forState:UIControlStateNormal];
...
- (UIView *)noticeView {
    if (!_noticeView) {
        ...
        if (self.enableEdit) {
            ...
            [_editButton setImage:AUIInteractionLiveGetCommonImage(@"ic_living_notice_edit") forState:UIControlStateNormal];
