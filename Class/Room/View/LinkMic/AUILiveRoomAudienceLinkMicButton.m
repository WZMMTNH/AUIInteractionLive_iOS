...
- (AVBlockButton *)mainButton {
    if (!_mainButton) {
        ...
        [mainButton setImage:AUIInteractionLiveGetCommonImage(@"ic_living_bottom_link") forState:UIControlStateNormal];
        [mainButton setBackgroundColor:UIColor.clearColor forState:UIControlStateNormal];
        [mainButton setBackgroundColor:AUIInteractionLiveColourfulFillStrong forState:UIControlStateSelected];
...
- (AVBlockButton *)audioButton {
    if (!_audioButton) {
        ...
        [audioButton setImage:AUIInteractionLiveGetCommonImage(@"ic_linkmic_audio") forState:UIControlStateNormal];
        [audioButton setImage:AUIInteractionLiveGetCommonImage(@"ic_linkmic_audio_selected") forState:UIControlStateSelected];
...
- (AVBlockButton *)videoButton {
    if (!_videoButton) {
        ...
        [videoButton setImage:AUIInteractionLiveGetCommonImage(@"ic_linkmic_video") forState:UIControlStateNormal];
        [videoButton setImage:AUIInteractionLiveGetCommonImage(@"ic_linkmic_video_selected") forState:UIControlStateSelected];
...
- (AVBlockButton *)cameraButton {
    if (!_cameraButton) {
        ...
        [cameraButton setImage:AUIInteractionLiveGetCommonImage(@"ic_linkmic_camera") forState:UIControlStateNormal];
