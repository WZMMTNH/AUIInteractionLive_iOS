...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _anchorFlag.backgroundColor = AUIInteractionLiveColourfulFillStrong;
        ...
        [_nickNameLabel setImage:AUIInteractionLiveGetCommonImage(@"ic_linkmic_win_audio") forState:UIControlStateNormal];
        [_nickNameLabel setImage:AUIInteractionLiveGetCommonImage(@"ic_linkmic_win_audio_selected") forState:UIControlStateSelected];
...
- (void)insertDisplayView:(AUILiveRoomLiveDisplayView *)displayView atIndex:(NSUInteger)index {
    ...
    if (index < self.viewList.count) {
        AUILiveRoomLiveDisplayView *indexView = [self.viewList objectAtIndex:index];
...
- (CGRect)displayRect:(AUILiveRoomLiveDisplayView *)displayView {
