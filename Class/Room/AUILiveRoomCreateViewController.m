//
//  AUILiveRoomCreateViewController.m
...
@interface AUILiveRoomCreateViewController () <UITextFieldDelegate>
...
@implementation AUILiveRoomCreateViewController
...
- (void)viewDidLoad {
    ...
    [baseLiveButton setImage:AUIRoomGetImage(@"ic_radio_unselected") forState:UIControlStateNormal];
    [baseLiveButton setImage:AUIRoomGetImage(@"ic_radio_selected") forState:UIControlStateSelected];
    ...
    [interactionLiveButton setImage:AUIRoomGetImage(@"ic_radio_unselected") forState:UIControlStateNormal];
    [interactionLiveButton setImage:AUIRoomGetImage(@"ic_radio_selected") forState:UIControlStateSelected];
