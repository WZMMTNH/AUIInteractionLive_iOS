...
@protocol AUIRoomMessageDataModel <NSObject>
...
- (void)sendData:(nullable id<AUIRoomMessageDataModel>)data type:(AUIRoomMessageType)type uids:(nullable NSArray<NSString *> *)uids skipMuteCheck:(BOOL)skipMuteCheck skipAudit:(BOOL)skipAudit completed:(nullable void(^)(BOOL))completed;
...
@property (nonatomic, copy) void (^onReceivedMuteAll)(AUIRoomUser *sender, BOOL isMuteAll);
@property (nonatomic, copy) void (^onReceivedNoticeUpdate)(AUIRoomUser *sender, NSString *notice);
