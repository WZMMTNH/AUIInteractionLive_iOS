...
@implementation AUILiveDetailButton
...
- (instancetype)initWithFrame:(CGRect)frame image:(UIImage *)image title:(NSString *)title{
    ...
    if (self) {
        ...
        [memberdowndropFlagImageButton setImage:AUIInteractionLiveGetImage(@"按钮-返回") forState:UIControlStateNormal];
